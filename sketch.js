...
function draw() {
  ...
  if(keyDown(LEFT_ARROW)){
    ...
    balloon.addAnimation("left",ballonImage2)
  }
  else if(keyDown(RIGHT_ARROW)){
    updateHeight(10,0);
    // Agrega la animación del globo [usa balloonImage2]

    balloon.addAnimation("right",ballonImage2)
  }
  else if(keyDown(UP_ARROW)){
    updateHeight(0,-10);
    // Agrega la animación del globo [usa balloonImage2]

    balloon.addAnimation("up",ballonImage2)
    ...
    balloon.addAnimation("down",ballonImage2)
    balloon.scale=balloon.scale+0.005;
  }
